    ...
    Widget buildCurrentPath(BuildContext context) {
      return Listener(
        onPointerDown: (details) {
          ...
          currentSketch.value = Sketch(points: [offset], color: selectedColor.value, size: strokeSize.value, mode: drawingMode.value);
        },    
        onPointerMove: (details) {
          ...
          currentSketch.value = Sketch(points: points, color: selectedColor.value, size: strokeSize.value, mode: drawingMode.value);
          }
        ,
        onPointerUp: (details) {
        ...
        child: RepaintBoundary(
          child: SizedBox(
            ...
            child: CustomPaint(
              painter: SketchPainter(
                sketches: currentSketch.value == null ? [] : [currentSketch.value!],
              ),
            ),
          ),
        ),
